...
if __name__ == '__main__':
    path = FilePathManager.resolve("face_recognition/models/evm/evm.model")
    evm = EvmPredictor(path)
    evm.predict_from_path(FilePathManager.resolve("face_recognition/test_images/image_1.jpg"))
