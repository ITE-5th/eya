...
def inception_extractor(use_cuda=True):
    from face_recognition.recognition.pretrained.inceptionresnetv2 import inceptionresnetv2

    path_of_pretrained_model = FilePathManager.resolve("face_recognition/data/inceptionresnetv2.pth")
...
def vgg_extractor(use_cuda=True):
    from face_recognition.recognition.pretrained.vgg_face import VGG_FACE
    extractor = VGG_FACE
